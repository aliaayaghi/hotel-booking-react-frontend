...
const PAYMENT_STATUS = {
  ...
  FAILED:          { bg: "#fee2e2", color: "#991b1b", label: "Failed" },
  PENDING_REFUND:  { bg: "#fef3c7", color: "#92400e", label: "Refund pending" },
...
const MAPS = { booking: BOOKING_STATUS, hotel: HOTEL_STATUS, payment: PAYMENT_STATUS, user: USER_STATUS, role: ROLE_STYLE };
